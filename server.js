...
const { getHome, testProductosRandom, getLogin, postLogin, getRegister, postRegister, postLogout, getInfo, getApiRandoms } = require("./routes");
...
app.post('/login', passport.authenticate("login", { failureRedirect: "/loginErrorAuth" }), postLogin);
...
app.post('/register', passport.authenticate("signup", { failureRedirect: "/registerErrorAuth" }), postRegister)
